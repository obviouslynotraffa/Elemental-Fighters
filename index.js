...
const keyPress = key => {
    ...
    if((ispressedPlayer === 68 || ispressedPlayer === 65) && player.canMove() && playerCanRoll && !timerRunOut()){
    ...
    //enemy double touch detection
    if((ispressedEnemy === 37 || ispressedEnemy === 39) && enemy.canMove() && enemyCanRoll && !timerRunOut()){
